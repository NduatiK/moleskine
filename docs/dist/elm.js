...
var $author$project$Gen$Route$Artculture__Home_ = {$: 'Artculture__Home_'};
...
var $author$project$Gen$Params$Artculture$Home_$parser = A2(
	$elm$url$Url$Parser$slash,
	$elm$url$Url$Parser$s('artculture'),
...
var $author$project$Gen$Route$routes = _List_fromArray(
	[
		...
		A2($elm$url$Url$Parser$map, $author$project$Gen$Route$Artculture__Home_, $author$project$Gen$Params$Artculture$Home_$parser)
	]);
...
var $author$project$Gen$Model$Artculture__Home_ = function (a) {
	return {$: 'Artculture__Home_', a: a};
};
...
var $author$project$Pages$Artculture$Home_$gray = function (intensity) {
	return A3($mdgriffith$elm_ui$Element$rgb, intensity, intensity, intensity);
};
...
var $author$project$Pages$Artculture$Home_$background = function () {
	var bgText = A2(
		$mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$Font$bold,
				$mdgriffith$elm_ui$Element$Font$size(450),
				$mdgriffith$elm_ui$Element$Font$letterSpacing(20),
				$mdgriffith$elm_ui$Element$alpha(0.1),
				$mdgriffith$elm_ui$Element$centerY,
				$mdgriffith$elm_ui$Element$centerX,
				$mdgriffith$elm_ui$Element$moveRight(120)
			]),
		$mdgriffith$elm_ui$Element$text('noise'));
	var bgImage = A2(
		$mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Element$px(587)),
				$mdgriffith$elm_ui$Element$Background$gradient(
				{
					angle: 0,
					steps: _List_fromArray(
						[
							$author$project$Pages$Artculture$Home_$gray(0.3),
							$author$project$Pages$Artculture$Home_$gray(0.2)
						])
				}),
				$mdgriffith$elm_ui$Element$Border$rounded(450),
		...
		A2(
			...
			{description: 'A sculture of a roman emperor', src: 'sculpture.png'}));
	return A2(
		$mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Element$clip,
				$mdgriffith$elm_ui$Element$inFront(bgText),
				$mdgriffith$elm_ui$Element$inFront(bgImage)
			]),
...
var $author$project$Pages$Artculture$Home_$enterButton = function () {
	var w = 180;
	var h = 75;
	return A2(
		$mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$moveDown(60),
				...
				A2(
					...
					_List_fromArray(
						[
							...
							$mdgriffith$elm_ui$Element$moveUp(h / 2.4),
							$mdgriffith$elm_ui$Element$moveLeft(w / 2.8),
							$mdgriffith$elm_ui$Element$rotate((-$elm$core$Basics$pi) / 11)
						]),
						...
						A2(
							...
							_List_fromArray(
								[
									...
									'-5 -5 ' + ($elm$core$String$fromInt(w + 10) + (' ' + $elm$core$String$fromInt(h + 10))))
								]),
							_List_fromArray(
								[
									A2(
									...
									_List_fromArray(
										[
											...
											$elm$svg$Svg$Attributes$stroke('#ff5722'),
											$elm$svg$Svg$Attributes$strokeWidth('2'),
											$elm$svg$Svg$Attributes$strokeOpacity('0.4')
										]),
									_List_Nil)
								]))))),
				$mdgriffith$elm_ui$Element$inFront(
...
var $author$project$Pages$Artculture$Home_$white = A3($mdgriffith$elm_ui$Element$rgb, 1, 1, 1);
var $author$project$Pages$Artculture$Home_$footer = A2(
	$mdgriffith$elm_ui$Element$row,
	_List_fromArray(
		[
			$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
			A2($mdgriffith$elm_ui$Element$paddingXY, 60, 40),
		...
		[
			...
			_List_fromArray(
				[
					...
					$mdgriffith$elm_ui$Element$el,
					_List_Nil,
					$mdgriffith$elm_ui$Element$text('FB')),
					A2(
					$mdgriffith$elm_ui$Element$el,
					_List_Nil,
					...
					$mdgriffith$elm_ui$Element$el,
					_List_Nil,
					$mdgriffith$elm_ui$Element$text('TW')),
					A2(
					$mdgriffith$elm_ui$Element$el,
					_List_Nil,
					$mdgriffith$elm_ui$Element$text('/')),
					...
					$mdgriffith$elm_ui$Element$el,
					_List_Nil,
					$mdgriffith$elm_ui$Element$text('IG'))
				])),
			A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$Background$color($author$project$Pages$Artculture$Home_$white),
							$mdgriffith$elm_ui$Element$height(
...
var $author$project$Pages$Artculture$Home_$navbar = A2(
	$mdgriffith$elm_ui$Element$row,
	_List_fromArray(
		[
			$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
	...
	_List_fromArray(
		[
			$mdgriffith$elm_ui$Element$text('ARTCULTURE'),
			A2(
			$mdgriffith$elm_ui$Element$row,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					$mdgriffith$elm_ui$Element$text('SHOP'),
					$mdgriffith$elm_ui$Element$text('PORTFOLIO'),
					$mdgriffith$elm_ui$Element$text('ABOUT US')
				]))
		]));
...
var $author$project$Pages$Artculture$Home_$sideScroller = A2(
	$mdgriffith$elm_ui$Element$column,
	_List_fromArray(
		[
			A2($mdgriffith$elm_ui$Element$paddingXY, 60, 40),
			...
			$author$project$Pages$Artculture$Home_$gray(0.7)),
			$mdgriffith$elm_ui$Element$centerY,
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[$mdgriffith$elm_ui$Element$centerX]),
			$mdgriffith$elm_ui$Element$text('01')),
			A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
				[
					...
					$author$project$Pages$Artculture$Home_$gray(0.4))
				]),
			$mdgriffith$elm_ui$Element$none),
			A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
				[
					...
					$mdgriffith$elm_ui$Element$Font$heavy,
					$mdgriffith$elm_ui$Element$Font$color($author$project$Pages$Artculture$Home_$white)
				]),
			$mdgriffith$elm_ui$Element$text('02')),
			A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[$mdgriffith$elm_ui$Element$centerX]),
			$mdgriffith$elm_ui$Element$text('03'))
		]));
...
var $author$project$Pages$Artculture$Home_$view = {
			...
			A2(
				...
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
						$mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$fill),
						$mdgriffith$elm_ui$Element$inFront($author$project$Pages$Artculture$Home_$navbar),
						$mdgriffith$elm_ui$Element$inFront($author$project$Pages$Artculture$Home_$sideScroller),
						$mdgriffith$elm_ui$Element$behindContent($author$project$Pages$Artculture$Home_$background),
						$mdgriffith$elm_ui$Element$inFront(
						A2(
							$mdgriffith$elm_ui$Element$el,
							_List_fromArray(
							...
							$author$project$Pages$Artculture$Home_$footer))
					]),
				A2(
					$mdgriffith$elm_ui$Element$row,
					_List_fromArray(
						...
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											...
											A2(
												...
												_List_fromArray(
													[
														$mdgriffith$elm_ui$Element$moveLeft(600),
														$mdgriffith$elm_ui$Element$moveUp(40),
														$mdgriffith$elm_ui$Element$Font$size(160),
														$mdgriffith$elm_ui$Element$Font$family(
														_List_fromArray(
															[
												...
												$mdgriffith$elm_ui$Element$text('Sculpture'))),
									...
									_List_fromArray(
										[
											$mdgriffith$elm_ui$Element$text('Presentation of new and future contemporary artists from around the world. A history surrounding many of the industry\'s most famous artisans')
										])),
									$author$project$Pages$Artculture$Home_$enterButton
								])),
							A2(
							$mdgriffith$elm_ui$Element$column,
							_List_fromArray(
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$mdgriffith$elm_ui$Element$text('Discover'),
											$mdgriffith$elm_ui$Element$text('Art History')
										])),
									A2(
									$mdgriffith$elm_ui$Element$paragraph,
									_List_fromArray(
									...
									_List_fromArray(
										[
											$mdgriffith$elm_ui$Element$text('Discover and learn about art and sculptures. In this article we will describe the understanding of art and modern art and how they affect the lives of ordinary people. Check the article now.')
										]))
								]))
						]))))),
	title: 'Homepage'
...
var $author$project$Gen$Pages$pages = {
	artculture__home_: A2($author$project$Gen$Pages$static, $author$project$Pages$Artculture$Home_$view, $author$project$Gen$Model$Artculture__Home_),
...
var $author$project$Gen$Pages$init = function (route) {
	if (route.$ === 'Artculture__Home_') {
		return $author$project$Gen$Pages$pages.artculture__home_.init(_Utils_Tuple0);
	} else {
...
var $author$project$Gen$Pages$subscriptions = function (model_) {
	switch (model_.$) {
		...
		case 'Artculture__Home_':
			var params = model_.a;
			return A2($author$project$Gen$Pages$pages.artculture__home_.subscriptions, params, _Utils_Tuple0);
		default:
			var params = model_.a;
...
var $author$project$Gen$Pages$view = function (model_) {
	switch (model_.$) {
		...
		case 'Artculture__Home_':
			var params = model_.a;
			return A2($author$project$Gen$Pages$pages.artculture__home_.view, params, _Utils_Tuple0);
		default:
			var params = model_.a;
